...
````groovy
dependencies {
    implementation "com.paulrybitskyi:hilt-binder:1.0.0-alpha03"
    annotationProcessor "com.paulrybitskyi:hilt-binder-compiler:1.0.0-alpha03"
}
````
...
dependencies {
    implementation "com.paulrybitskyi:hilt-binder:1.0.0-alpha03"
    kapt "com.paulrybitskyi:hilt-binder-compiler:1.0.0-alpha03"
}
````
