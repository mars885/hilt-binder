...
internal class ModuleFileGenerator(
    ...
    fun generateFiles(moduleSchemas: List<ModuleSchema>) {
        for(moduleSchema in moduleSchemas) {
            ...
            val kotlinFile = typeSpec.generateKotlinFile(moduleSchema.packageName)
    ...
    private fun TypeSpec.generateKotlinFile(packageName: String): FileSpec {
        return FileSpec.builder(packageName, this.name!!)
