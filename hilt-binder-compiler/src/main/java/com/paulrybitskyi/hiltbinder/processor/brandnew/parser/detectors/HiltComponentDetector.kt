...
import com.paulrybitskyi.hiltbinder.processor.brandnew.utils.*
...
internal class HiltComponentDetector(
    ...
    private fun shouldInstallInViewWithFragmentComponent(annotatedElement: XTypeElement): Boolean {
        ...
        val withFragmentBindingsType = processingEnv.getTypeUnsafely(WITH_FRAGMENT_BINDINGS_TYPE_QUALIFIED_NAME)
