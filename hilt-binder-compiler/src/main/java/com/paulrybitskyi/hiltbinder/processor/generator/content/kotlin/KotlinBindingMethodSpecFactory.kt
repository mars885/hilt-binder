...
import com.paulrybitskyi.hiltbinder.processor.generator.content.utils.DAGGER_TYPE_BINDS_KOTLIN_CLASS_NAME
import com.paulrybitskyi.hiltbinder.processor.generator.content.utils.DAGGER_TYPE_INTO_MAP_KOTLIN_CLASS_NAME
import com.paulrybitskyi.hiltbinder.processor.generator.content.utils.DAGGER_TYPE_INTO_SET_KOTLIN_CLASS_NAME
        ...
        return when(this) {
            ...
            is ReturnType.Generic -> when(this) {
                ...
                is ReturnType.Generic.UnboundedWildcard -> {
                    ...
                    type.typeElement.kotlinClassName.parameterizedBy(typeArgs)
                }
            }
        }
    }
