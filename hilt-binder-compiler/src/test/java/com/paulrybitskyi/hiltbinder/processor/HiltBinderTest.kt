...
internal class HiltBinderTest {
    ...
    internal companion object {
        ...
        enum class Scenario(
            ...
            JAVAC_JAVA_JAVA(ProcessorType.JAVAC, Language.JAVA, Language.JAVA),
            JAVAC_KOTLIN_JAVA(ProcessorType.JAVAC, Language.KOTLIN, Language.JAVA),
            KSP_JAVA_KOTLIN(ProcessorType.KSP, Language.JAVA, Language.KOTLIN),
            KSP_KOTLIN_KOTLIN(ProcessorType.KSP, Language.KOTLIN, Language.KOTLIN)
    ...
    fun `Binds class with custom qualifier`(scenario: Scenario) {
        ...
        Assume.assumeTrue(Scenario.KSP_JAVA_KOTLIN != scenario)
    ...
    private fun setupCompilation(
        ...
        val compilation = KotlinCompilation().apply {
            ...
            when(processorType) {
                ...
                ProcessorType.KSP -> symbolProcessorProviders = listOf(HiltBinderKspProcessorProvider())
            }
        }
